...
namespace FunctionalAnalyzers
{
    public class Startup
    {
        public Startup(IDependencyResolver dependencyResolver = null)
        {
            ...
            RxApp.DefaultExceptionHandler = new FunctionalAnalyzersExceptionHandler();
        ...
        {
            dependencyResolver.RegisterViewModel<MainViewModel>(() => new MainViewModel(new SettingsProvider()));
        }
